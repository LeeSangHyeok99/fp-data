...
weekly = df[deployers].resample('W-MON').last()
weekly = weekly / 1e6  # Convert to $M

# ══════════════════════════════════════════════════
# Colors (muted blue-green palette, matching reference)
# ══════════════════════════════════════════════════
deployer_colors = {
...
# Save
# ══════════════════════════════════════════════════
png_path, svg_path = save_chart(fig, 'hip3_deployer_oi_growth',
