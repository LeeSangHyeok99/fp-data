...
df = pd.read_csv('outputs/data/distressed_debt_absolute_opportunity.csv')
...
png_path = f"{output_dir}/global_distressed_debt_absolute_opportunity.png"
svg_path = f"{output_dir}/global_distressed_debt_absolute_opportunity.svg"
