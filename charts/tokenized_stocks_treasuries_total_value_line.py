...
NAME = "tokenized_stocks_treasuries_total_value_line"
...
ax_r.plot(treas.index, treas.values, color=LIGHT, lw=2.4, solid_capstyle="round")
ax_l.plot(stocks.index, stocks.values, color=BLUE, lw=2.4, solid_capstyle="round")
